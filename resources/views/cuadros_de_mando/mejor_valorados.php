...
<div class="container-fluid">
 ...
 $aux = $bd->getSelect('SELECT avg(t.valoracion) as total,t.idempleado, e.nombre from trabajo t,empleado e
where t.idempleado = e.idempleado
group by t.idempleado, e.nombre order by total desc limit 10');
