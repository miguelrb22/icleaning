...
<div class="container-fluid">
 ...
 $aux = $bd->getSelect('SELECT sum(importe_total) as importe, nombre FROM gi_telelimpieza.trabajos_zonas group by idzona,nombre order by
importe desc limit 10');
 ...
 foreach($aux as $a){
    ...
    array_push($valores ,$a['importe']);
    array_push($nombre, utf8_encode($a['nombre']));

}

for($i=0; $i < count($nombre);$i++) {
    array_push($nombres,$nombre[$i]);
}
