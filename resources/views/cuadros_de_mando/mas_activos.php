...
<div class="container-fluid">
    <div class="row">
     ...
     $aux = $bd->getSelect('SELECT count(t.idempleado) as total,t.idempleado, e.nombre from trabajo t,empleado e where t.idempleado = e.idempleado group by t.idempleado, e.nombre order by total desc limit 10');
