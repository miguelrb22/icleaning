...
//$empleado = new Trabajador(0, 1, 48, $traNif, $traApellidos, $traNombre, $telefono, $email, $numCuenta, $traSip, $traExperiencia, '2015-01-01', 0, $traContrasenya, '',$traDescripcion, 1);
$empleado2 = new Trabajador(0, 1, 48, 14553322, 'nyanya', 'qwe', 44332211, 'purpurpur', 1243124, 3141423, 2, '2015-01-01', 4, 'purClear', '', 'Desc', 3);

$trabajadorController->insertEmpleado($empleado2);
